...
#ifndef EYEREST_SWIFT_H
#define EYEREST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EyeRest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7EyeRest11AppDelegate")
...
SWIFT_CLASS("_TtC7EyeRest15OverlayNSWindow")
@interface OverlayNSWindow : NSWindow
...
SWIFT_CLASS("_TtC7EyeRest23OverlayWindowController")
